 ...
 * @version 2021-08-15
 */
public class ChineseKits {
    public static final List<String> FAMILY_NAME = Lists.newArrayList("赵", "钱", "孙", "李", "周", "吴", "郑", "王", "冯", "陈",
            "褚",
            "卫", "蒋", "沈", "韩", "杨", "朱", "秦",
    ...
    public static String getFamilyName() {
        return FAMILY_NAME.get(random.nextInt(FAMILY_NAME.size()));
    }
